...
namespace ChatApp_Api.Migrations
{
    ...
    [Migration("20240930082514_addGroupChat")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChatApp_Api.Entities.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChatApp_Api.Entities.AppUserRole", b =>
                {
            ...
            modelBuilder.Entity("ChatApp_Api.Entities.Connection", b =>
                {
            ...
            modelBuilder.Entity("ChatApp_Api.Entities.AppUserRole", b =>
                {
                    b.HasOne("ChatApp_Api.Entities.AppRole", "Role")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("ChatApp_Api.Entities.Connection", b =>
                {
                    b.HasOne("ChatApp_Api.Entities.Group", null)
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("ChatApp_Api.Entities.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("ChatApp_Api.Entities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
